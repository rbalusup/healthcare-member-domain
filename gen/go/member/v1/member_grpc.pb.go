...
const (
	MemberService_CreateMember_FullMethodName         = "/healthcare.member.v1.MemberService/CreateMember"
	MemberService_GetMember_FullMethodName            = "/healthcare.member.v1.MemberService/GetMember"
	MemberService_UpdateMember_FullMethodName         = "/healthcare.member.v1.MemberService/UpdateMember"
	MemberService_ListMembers_FullMethodName          = "/healthcare.member.v1.MemberService/ListMembers"
	MemberService_EnrollMember_FullMethodName         = "/healthcare.member.v1.MemberService/EnrollMember"
	MemberService_GetMemberRiskProfile_FullMethodName = "/healthcare.member.v1.MemberService/GetMemberRiskProfile"
)
...
func (c *memberServiceClient) EnrollMember(ctx context.Context, in *EnrollMemberRequest, opts ...grpc.CallOption) (*Member, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Member)
	err := c.cc.Invoke(ctx, MemberService_EnrollMember_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberServiceClient) GetMemberRiskProfile(ctx context.Context, in *GetMemberRiskProfileRequest, opts ...grpc.CallOption) (*RiskProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RiskProfile)
	err := c.cc.Invoke(ctx, MemberService_GetMemberRiskProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMemberServiceServer) EnrollMember(context.Context, *EnrollMemberRequest) (*Member, error) {
	return nil, status.Error(codes.Unimplemented, "method EnrollMember not implemented")
}
func (UnimplementedMemberServiceServer) GetMemberRiskProfile(context.Context, *GetMemberRiskProfileRequest) (*RiskProfile, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMemberRiskProfile not implemented")
}
...
func _MemberService_EnrollMember_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemberService_EnrollMember_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MemberService_GetMemberRiskProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemberService_GetMemberRiskProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
